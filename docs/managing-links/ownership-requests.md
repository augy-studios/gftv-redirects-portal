...
An ownership request is a formal ask to become the owner of a link you do not currently own. The current owner can approve or reject it. If approved, the link is transferred to you immediately.

{% hint style="info" %}
Ownership requests go to the **current link owner**, not to an Admin. If the owner is unavailable, an Admin can perform a direct transfer without a request.
{% endhint %}

## Requesting ownership of a link

1. Find the link in the public [Directory](../directory/browsing-the-directory.md).
2. Click on the link card to view its details.
...
If you simply want to hand a link to a known colleague without going through the request flow, you can do a **direct transfer** from the link edit panel:

1. Open the edit panel for the link from your Dashboard.
2. Enter the username of the new owner in the **Owner** field.
3. Click **Save**.

See [Editing a Link](editing-a-link.md) for more details.
