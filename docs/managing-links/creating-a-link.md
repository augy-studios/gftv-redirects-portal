...
- **Active** by default — visitors are redirected immediately.
...
**Can I choose any slug I want?**
Yes, as long as it follows the format rules and isn't already taken. Check the Directory first to avoid conflicts.

**What if I don't choose a slug?**
Leave the slug field blank and the platform will auto-generate a random 8-character slug.

**Can I change the slug after creating the link?**
Yes. Edit your link from the Dashboard and update the slug. Keep in mind that the old slug will stop working immediately after the change.

**Is there a limit on how many links I can create?**
There is currently no per-user link limit.
