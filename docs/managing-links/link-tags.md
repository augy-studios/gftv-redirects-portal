...
Tags can be added when [creating a link](creating-a-link.md) or later when [editing a link](editing-a-link.md).

1. In the create or edit panel, click the **Tags** field.
2. Type your tag and press **Enter** (or the add button).
3. Repeat for additional tags (up to 5).
4. Click **Save** (when editing an existing link).

To remove a tag, click the **×** next to it in the tag list.
