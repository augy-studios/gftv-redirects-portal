...
CREATE INDEX IF NOT EXISTS idx_trusted_devices_user_id ON gftvlinks_trusted_devices(user_id);

-- Index for efficient lookup by device_token during login
CREATE INDEX IF NOT EXISTS idx_trusted_devices_device_token ON gftvlinks_trusted_devices(device_token);
